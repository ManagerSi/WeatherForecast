...
namespace WeatherLib.DAL
{
    ...
    public partial interface IJD_ProductRepository:
        WeatherLib.Infrastructure.DAL.IRepository<JD_Product>
    {
      }
    
    public partial class JD_ProductRepository:
       WeatherLib.Infrastructure.DAL.GenericRepository<JD_Product>,
       WeatherLib.DAL.IJD_ProductRepository
    {

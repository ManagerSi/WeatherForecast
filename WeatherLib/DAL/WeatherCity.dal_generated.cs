...
namespace WeatherLib.DAL
{
    ...
    public partial interface IWeatherCityRepository:
        WeatherLib.Infrastructure.DAL.IRepository<WeatherCity>
    {
      }
    
    public partial class WeatherCityRepository:
       WeatherLib.Infrastructure.DAL.GenericRepository<WeatherCity>,
       WeatherLib.DAL.IWeatherCityRepository
    {

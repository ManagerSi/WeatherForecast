...
namespace WeatherLib.DAL
{
    ...
    public partial interface IBaseUserRepository:
        WeatherLib.Infrastructure.DAL.IRepository<BaseUser>
    {
      }
    
    public partial class BaseUserRepository:
       WeatherLib.Infrastructure.DAL.GenericRepository<BaseUser>,
       WeatherLib.DAL.IBaseUserRepository
    {
